...
public class GroceryStore implements Closeable {
    ...
    public void addGroceryItem(String name, String amount) {
        ...
        database.insertWithOnConflict(SQLiteDB.GROCERY_TABLE, null, values,
    ...
    public void changeStrokeVisibilityOfGroceryItem(CharSequence groceryItemName) {
        ...
        try {
            ...
            LOGGER.d(e, "User wanted to stroke \"%s\" but it's not in the database.",
                     groceryItemName);
        }
    ...
    public void addIngredientsToGroceryList(List<Ingredient> ingredients) {
        ...
        for (Ingredient ingredient : ingredients) {
            try {
                ...
                ingredient.setAmount(StringTools.mergeAmounts(ingredient.getAmount(),
                                                              oldGroceryItem.getAmount()));
            } catch (ItemNotFoundException e) {
