 ...
 * #setViewPager(ViewPager)} providing it the ViewPager this layout is being used for. <p>
 * Use {@link TabColorizer} interface which provides you complete control over
 * which color is used for any individual position. <p>
 */
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabTitleView != null) {
                ...
                tabTitleView.setTextColor(ContextCompat.getColor(getContext(),
                                                                 R.color.any_white_gray));
            }
